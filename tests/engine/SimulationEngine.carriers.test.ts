...
describe("SimulationEngine multiple carrier behaviour", () => {
  it("should handle multiple carriers independently", () => {
    ...
    const input: SimulationInput = {
      ...
      carriers: [new Carrier(1, new Position(0, 0)), new Carrier(2, new Position(3, 3))],
      moves: ["R"]
    };
  ...
  it("should allow multiple carriers to share the same position", () => {
    ...
    const input: SimulationInput = {
      ...
      carriers: [new Carrier(1, new Position(1, 1)), new Carrier(2, new Position(1, 1))],
      moves: []
    };
  ...
  it("should keep contamination created by earlier carriers", () => {
    ...
    const input: SimulationInput = {
      ...
      carriers: [new Carrier(1, new Position(0, 0)), new Carrier(2, new Position(1, 0))],
      moves: ["R"]
    };
